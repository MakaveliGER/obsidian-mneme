...
# ---------------------------------------------------------------------------
# serialize_results — result serialization helper
# ---------------------------------------------------------------------------
...
def testserialize_results_adds_relevance_pct():
    from mneme.server import serialize_results
    results = [
...
def testserialize_results_falls_back_to_heading_when_snippet_empty():
...
def testserialize_results_strips_context_header_from_content():
    from mneme.server import serialize_results
    results = [
        _make_sr(
            "note.md",
